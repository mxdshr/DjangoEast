# Generated by Django 2.0.8 on 2019-09-04 03:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.blog.Category', verbose_name='文章分类')),
            ],
            options={
                'verbose_name': '文章列表',
        ...
        migrations.AddField(
            model_name='post',
            name='tag',
            field=models.ManyToManyField(blank=True, to='apps.blog.Tag', verbose_name='标签类型'),
        ),
        migrations.AddField(
            model_name='movie',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.blog.MovieCategory', verbose_name='电影分类'),
        ),
        migrations.AddField(
            model_name='movie',
            name='tag',
            field=models.ManyToManyField(to='apps.blog.MovieTag', verbose_name='电影标签'),
        ),
        migrations.AddField(
            model_name='courses',
            name='article',
            field=models.ManyToManyField(blank=True, to='apps.blog.Post', verbose_name='教程文章'),
        ),
        migrations.AddField(
            model_name='courses',
            name='author',
        ...
        migrations.AddField(
            model_name='book',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.blog.BookCategory', verbose_name='书籍分类'),
        ),
        migrations.AddField(
            model_name='book',
            name='tag',
            field=models.ManyToManyField(to='apps.blog.BookTag', verbose_name='本书标签'),
        ),
    ]
